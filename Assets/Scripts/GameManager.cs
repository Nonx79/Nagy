...
public class GameManager : MonoBehaviour
{
    ...
    public Image heart1, heart2, sword1, sword2, face1, face2;
    ...
    public void UnitsUI()
    {
        ...
        {
            if (u.GetComponent<Unit>().playerNum == 1)
            {
                unitsPlayer1 = unitsPlayer1 + 1;
            }

            if (u.GetComponent<Unit>().playerNum == 2)
            {
                unitsPlayer2 = unitsPlayer2 + 1;
            }
        }
        
        switch (factionChoose1)
        {
            case 0:
                unitP1.GetComponent<SpriteRenderer>().sprite = mSoldier;
                break;
            case 1:
                unitP1.GetComponent<SpriteRenderer>().sprite = pSoldier;
                break;
            case 2:
                unitP1.GetComponent<SpriteRenderer>().sprite = rSoldier;
                break;
        }

        switch (factionChoose2)
        {
            case 0:
                unitP2.GetComponent<SpriteRenderer>().sprite = mSoldier;
                break;
            case 1:
                unitP2.GetComponent<SpriteRenderer>().sprite = pSoldier;
                break;
            case 2:
                unitP2.GetComponent<SpriteRenderer>().sprite = rSoldier;
                break;
        }        
    }
    ...
    public void UnitUIUpdate()
    {
        if (!displayingUnitInfo)
        {
            if (hit.transform.CompareTag("Tile"))
            {
                if (hit.transform.GetComponent<ClickableTile>().unitOnTile != null && map.selectedUnit == null)
                {
                ...
                else if ((hit.transform.GetComponent<ClickableTile>().unitOnTile != null || hit.transform.GetComponent<ClickableTile>().structureOnTile != null)&& hit.transform.GetComponent<ClickableTile>().unitOnTile != map.selectedUnit    && map.selectedUnit != null)
                {
                    displayingUnitInfo = true;
                    ...
                    {
                        unitBeingDisplayed = hit.transform.GetComponent<ClickableTile>().structureOnTile;
                        iniDmg = map.selectedUnit.GetComponent<Structure>().dmg;
                        recDmg = unitBeingDisplayed.GetComponent<Structure>().dmg;
                    }                 
                    ...
                    if (iniDmg - 9 <= 0)
                        battle.text = "1" + "-" + iniDmg.ToString();
                    else
                        battle.text = (iniDmg - 9).ToString() + "-" + iniDmg.ToString();
    ...
    public void ColorPurple()
    {
        ...
        else if (canvasPlayer2.enabled == true && selectColor1 != morado)
        {
            selectColor2 = morado;
    ...
    public void ColorPink()
    {
        ...
        else if (canvasPlayer2.enabled == true && selectColor1 != rosa)
        {
            selectColor2 = rosa;
            map.positionCommander2.GetComponent<SpriteRenderer>().color = rosa;
        }
    ...
    public void ColorIntensePink()
    {
        ...
        else if (canvasPlayer2.enabled == true && selectColor1 != rosaIntenso)
        {
    ...
    public void ColorYellow()
    {
        ...
        else if (canvasPlayer2.enabled == true && selectColor1 != yellow)
        {
            selectColor2 = yellow;
    ...
    public void ColorLightBlue()
    {
        ...
        else if (canvasPlayer2.enabled == true && selectColor1 != azulClaro)
        {
    ...
    public void ColorOrange()
    {
        ...
        else if (canvasPlayer2.enabled == true && selectColor1 != orange)
        {
            selectColor2 = orange;
    ...
    public void Confirm()
    {
        if (canvasPlayer1.enabled == true && player1Commander != null)
        {
            commander.text = "";
            faction.text = "";
