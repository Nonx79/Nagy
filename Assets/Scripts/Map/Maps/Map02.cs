...
public class Map02 : MonoBehaviour
{
    ...
    private void Update()
    {		
		if (gm.canvasPlayer1.enabled == true)
        {
			color = gm.colorUnit;
			if (color == "Purple")
			{
			...
			else if (color == "IntensePink")
			{
				positionPlayer11.GetComponent<SpriteRenderer>().color = gm.rosaIntenso;
				positionPlayer12.GetComponent<SpriteRenderer>().color = gm.rosaIntenso;
			}

			else if (color == "Pink")
			{
				positionPlayer11.GetComponent<SpriteRenderer>().color = gm.rosa;
				positionPlayer12.GetComponent<SpriteRenderer>().color = gm.rosa;
			}

			else if (color == "LightBlue")
			{
				positionPlayer11.GetComponent<SpriteRenderer>().color = gm.azulClaro;
				positionPlayer12.GetComponent<SpriteRenderer>().color = gm.azulClaro;
			}

			else if (color == "Yellow")
			{
				positionPlayer11.GetComponent<SpriteRenderer>().color = gm.yellow;
				positionPlayer12.GetComponent<SpriteRenderer>().color = gm.yellow;
			}

			else if (color == "Orange")
			{
				positionPlayer11.GetComponent<SpriteRenderer>().color = gm.orange;
				positionPlayer12.GetComponent<SpriteRenderer>().color = gm.orange;
			}
		}

		if (gm.canvasPlayer2.enabled == true)
        {
			
			color = gm.colorUnit;
			if (color == "Purple")
			{
				positionPlayer21.GetComponent<SpriteRenderer>().color = gm.morado;
				positionPlayer22.GetComponent<SpriteRenderer>().color = gm.morado;
				positionPlayer23.GetComponent<SpriteRenderer>().color = gm.morado;
			}

			else if (color == "IntensePink")
			{
				positionPlayer21.GetComponent<SpriteRenderer>().color = gm.rosaIntenso;
				positionPlayer22.GetComponent<SpriteRenderer>().color = gm.rosaIntenso;
				positionPlayer23.GetComponent<SpriteRenderer>().color = gm.rosaIntenso;
			}
			...
			{
				positionPlayer21.GetComponent<SpriteRenderer>().color = gm.azulClaro;
				positionPlayer22.GetComponent<SpriteRenderer>().color = gm.azulClaro;
				positionPlayer23.GetComponent<SpriteRenderer>().color = gm.azulClaro;
			}

			else if (color == "Yellow")
			{
				positionPlayer21.GetComponent<SpriteRenderer>().color = gm.yellow;
				positionPlayer22.GetComponent<SpriteRenderer>().color = gm.yellow;
				positionPlayer23.GetComponent<SpriteRenderer>().color = gm.yellow;
			}

			else if (color == "Orange")
			{
				positionPlayer21.GetComponent<SpriteRenderer>().color = gm.orange;
				positionPlayer22.GetComponent<SpriteRenderer>().color = gm.orange;
				positionPlayer23.GetComponent<SpriteRenderer>().color = gm.orange;
			}
		}		
